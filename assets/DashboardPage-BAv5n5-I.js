import{j as e,a as I,b as M,r as b,L as f,N as A}from"./index-Drr3g0Na.js";import{u as q,a as D,b as O}from"./useDashboard-D3eBATNa.js";import{B as H}from"./book-open-XeYOw4U0.js";import{C as R}from"./clock-94A_lU3y.js";import{C as $}from"./circle-alert-1FzyG5Lb.js";import{E as G}from"./eye-CiQOqLtX.js";import{C as j}from"./chevron-right-gFtaFX27.js";import{c as E}from"./createLucideIcon-DjmxNK3c.js";import{L as _}from"./library-CR3N0st4.js";import{H as P}from"./ReviewHistoryModal-Dd1kYW8B.js";import{G as K}from"./graduation-cap-o6UBPCHB.js";import{C as L}from"./circle-check-DRLcDU2O.js";import{L as T}from"./loader-circle-6P3_tD7e.js";import{M as Q,R as U}from"./ReviewFeedbackModal-ByhNxWRR.js";import{u as W,a as X,b as Y}from"./useBrowse-DLs0YXXm.js";import{C as J}from"./chevron-left-D5sMlimf.js";import{X as Z}from"./x-CGAn5r1G.js";import{f as ee}from"./useModeration-4Gaxh6cc.js";import{R as te}from"./rotate-ccw-ezNekqf8.js";import{C as se}from"./circle-x-DyCKvltz.js";import"./useQuery-DgSdYVVF.js";import"./useMutation-CFPoYCAQ.js";import"./academics.api-BaXhmaWW.js";import"./StatusBadge-CZnnDOdf.js";import"./message-square-B8AFMnds.js";/**
 * @license lucide-react v0.395.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const V=E("FilePlus2",[["path",{d:"M4 22h14a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v4",key:"1pf5j1"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M3 15h6",key:"4e2qda"}],["path",{d:"M6 12v6",key:"1u72j0"}]]);/**
 * @license lucide-react v0.395.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ae=E("ListChecks",[["path",{d:"m3 17 2 2 4-4",key:"1jhpwq"}],["path",{d:"m3 7 2 2 4-4",key:"1obspn"}],["path",{d:"M13 6h8",key:"15sg57"}],["path",{d:"M13 12h8",key:"h98zly"}],["path",{d:"M13 18h8",key:"oe0vm4"}]]);function y({label:t,value:a,icon:r,colorClasses:i,isLoading:n}){return n?e.jsxs("div",{className:"bg-card rounded-card shadow-card p-5 flex items-center gap-4 animate-pulse",children:[e.jsx("div",{className:"w-11 h-11 rounded-xl bg-gray-200 shrink-0"}),e.jsxs("div",{className:"flex-1 space-y-2",children:[e.jsx("div",{className:"h-7 w-16 bg-gray-200 rounded"}),e.jsx("div",{className:"h-4 w-24 bg-gray-100 rounded"})]})]}):e.jsxs("div",{className:`
        bg-card rounded-card shadow-card p-5
        flex items-center gap-4
        transition-all duration-200
        hover:-translate-y-0.5 hover:shadow-card-hover
        cursor-default
      `,children:[e.jsx("div",{className:`w-11 h-11 rounded-xl flex items-center justify-center shrink-0 ${i}`,children:r}),e.jsxs("div",{children:[e.jsx("p",{className:"text-2xl font-bold text-ink tabular-nums leading-tight",children:a}),e.jsx("p",{className:"text-sm text-ink-muted mt-0.5",children:t})]})]})}function ne({stats:t,isLoading:a}){return e.jsxs("div",{className:"grid grid-cols-2 lg:grid-cols-4 gap-4",children:[e.jsx(y,{label:"Published",value:(t==null?void 0:t.publishedChapters)??0,icon:e.jsx(H,{size:20,className:"text-success"}),colorClasses:"bg-green-50",isLoading:a}),e.jsx(y,{label:"Pending Review",value:(t==null?void 0:t.pendingChapters)??0,icon:e.jsx(R,{size:20,className:"text-warning"}),colorClasses:"bg-yellow-50",isLoading:a}),e.jsx(y,{label:"Rejected",value:(t==null?void 0:t.rejectedChapters)??0,icon:e.jsx($,{size:20,className:"text-danger"}),colorClasses:"bg-red-50",isLoading:a}),e.jsx(y,{label:"Total Views",value:a?0:((t==null?void 0:t.totalViews)??0)>=1e3?`${(((t==null?void 0:t.totalViews)??0)/1e3).toFixed(1)}k`:(t==null?void 0:t.totalViews)??0,icon:e.jsx(G,{size:20,className:"text-accent"}),colorClasses:"bg-blue-50",isLoading:a})]})}function re({pendingCount:t,onViewPending:a}){return t<=0?null:e.jsxs("div",{className:`
        flex items-start gap-3
        bg-yellow-50 border border-yellow-200
        rounded-card px-4 py-3
        animate-fadeSlideIn
      `,role:"alert",children:[e.jsx(R,{size:18,className:"text-warning shrink-0 mt-0.5","aria-hidden":"true"}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("p",{className:"text-sm font-semibold text-yellow-800",children:t===1?"1 chapter awaiting review":`${t} chapters awaiting review`}),e.jsx("p",{className:"text-xs text-yellow-700 mt-0.5",children:"Chapters typically take 24–48 hours to review."})]}),e.jsxs("button",{onClick:a,className:`
          flex items-center gap-1 text-xs font-medium
          text-yellow-800 hover:text-yellow-900
          underline underline-offset-2
          shrink-0 mt-0.5
          transition-colors
        `,"aria-label":"View pending chapters",children:["View",e.jsx(j,{size:14})]})]})}function w({icon:t,label:a,onClick:r}){return e.jsxs("button",{onClick:r,className:`
      ...
      `,children:[e.jsx("span",{className:"shrink-0",children:t}),a]})}function ie(){const t=I(),{canAuthor:a,hasRole:r}=M();return e.jsxs("div",{className:"flex flex-wrap gap-3",children:[a()&&e.jsx(w,{icon:e.jsx(V,{size:16}),label:"New Chapter",onClick:()=>t("/academics/editor/new")}),e.jsx(w,{icon:e.jsx(_,{size:16}),label:"Browse Content",onClick:()=>t("/academics")}),r("moderator","admin")&&e.jsx(w,{icon:e.jsx(ae,{size:16}),label:"View Queue",onClick:()=>t("/academics/moderator/queue")}),r("moderator","admin")&&e.jsx(w,{icon:e.jsx(P,{size:16}),label:"History",onClick:()=>t("/academics/moderator/history")})]})}const le=["Write and publish chapters on paediatric & neonatal topics","Receive structured peer-review feedback from moderators","Earn CME/CPD credits for accepted contributions","Be listed as a verified author on PediAid Academics","Track views and reading time for your published work"];function ce(){const{mutate:t,isPending:a,isSuccess:r,error:i}=q();return e.jsxs("div",{className:"bg-card rounded-card shadow-card p-6 max-w-xl mx-auto animate-fadeSlideIn",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-3",children:[e.jsx("div",{className:"w-12 h-12 rounded-xl bg-blue-50 flex items-center justify-center shrink-0",children:e.jsx(K,{size:24,className:"text-accent","aria-hidden":"true"})}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-lg font-bold text-ink",children:"Become an Author"}),e.jsx("p",{className:"text-sm text-ink-muted leading-snug",children:"Share your expertise with the PediAid community"})]})]}),e.jsx("p",{className:"text-sm text-ink-muted mb-4 leading-relaxed",children:"Contribute chapters to PediAid Academics and help build the most comprehensive paediatric & neonatal clinical reference platform."}),e.jsx("ul",{className:"space-y-2 mb-6",children:le.map(n=>e.jsxs("li",{className:"flex items-start gap-2 text-sm text-ink",children:[e.jsx(L,{size:16,className:"text-success shrink-0 mt-0.5","aria-hidden":"true"}),n]},n))}),i&&e.jsx("p",{className:"text-sm text-danger mb-3",role:"alert",children:i.message}),r?e.jsxs("div",{className:`
            flex items-center gap-2
          ...
          `,role:"status",children:[e.jsx(L,{size:16,"aria-hidden":"true"}),"Request submitted! Our team will review your profile shortly."]}):e.jsx("button",{onClick:()=>t(),disabled:a,className:`
            ...
            transition-colors
          `,children:a?e.jsxs(e.Fragment,{children:[e.jsx(T,{size:16,className:"animate-spin","aria-hidden":"true"}),"Submitting…"]}):"Request Author Access"})]})}function oe({onClose:t}){const a=I(),[r,i]=b.useState("subject"),[n,c]=b.useState(null),[l,m]=b.useState(null),{data:x,isLoading:o}=W(),{data:h,isLoading:d}=X(n==null?void 0:n.id),{data:u,isLoading:k}=Y(l==null?void 0:l.id);function g(s){c(s),m(null),i("system")}function C(s){m(s),i("topic")}function N(s){t(),a(`/academics/editor/new?topicId=${s.id}`)}function S(){r==="topic"?i("system"):r==="system"&&(i("subject"),c(null))}function v(s){s.target===s.currentTarget&&t()}function p(s){s.key==="Escape"&&t()}const F={subject:"Select a Subject",system:"Select a System",topic:"Select a Topic"},B={subject:1,system:2,topic:3};return e.jsx("div",{className:`
        fixed inset-0 z-50
      ...
      `,role:"dialog","aria-modal":"true","aria-labelledby":"topic-selector-title",onClick:v,onKeyDown:p,tabIndex:-1,children:e.jsxs("div",{className:`
        ...
        `,children:[e.jsxs("div",{className:"flex items-center gap-3 px-5 py-4 border-b border-border",children:[r!=="subject"&&e.jsx("button",{onClick:S,className:`
              ...
              `,"aria-label":"Go back",children:e.jsx(J,{size:18})}),e.jsxs("div",{className:"flex-1",children:[e.jsx("h2",{id:"topic-selector-title",className:"text-base font-semibold text-ink",children:"New Chapter"}),e.jsxs("p",{className:"text-xs text-ink-muted mt-0.5",children:["Step ",B[r]," of 3 — ",F[r]]})]}),e.jsx("button",{onClick:t,className:`
              p-1.5 rounded-lg text-ink-muted hover:text-ink hover:bg-gray-100
              transition-colors
            `,"aria-label":"Close",children:e.jsx(Z,{size:18})})]}),(n||l)&&e.jsx("div",{className:"flex items-center gap-1.5 px-5 pt-3 text-xs text-ink-muted flex-wrap",children:n&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"font-medium text-ink",children:n.name}),l&&e.jsxs(e.Fragment,{children:[e.jsx(j,{size:12}),e.jsx("span",{className:"font-medium text-ink",children:l.name})]})]})}),e.jsxs("div",{className:"flex-1 overflow-y-auto px-5 py-4",children:[r==="subject"&&e.jsx(e.Fragment,{children:o?e.jsx(z,{}):e.jsx("div",{className:"flex flex-wrap gap-2",children:(x??[]).map(s=>e.jsxs("button",{onClick:()=>g(s),className:`
            ...
            active:scale-95
            transition-all duration-150
          `,"aria-label":"Create new chapter",children:[e.jsx(V,{size:18,"aria-hidden":"true"}),"New Chapter"]}),c&&e.jsx(U,{chapter:c,onClose:()=>l(null),onEdit:()=>l(null)}),m&&e.jsx(oe,{onClose:()=>x(!1)})]})}export{Oe as DashboardPage};
